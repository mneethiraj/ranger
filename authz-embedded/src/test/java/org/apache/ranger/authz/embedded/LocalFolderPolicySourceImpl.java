...
public class LocalFolderPolicySourceImpl extends AbstractRangerAdminClient {
    ...
    public void init(String serviceName, String appId, String configPropertyPrefix, Configuration config) {
        ...
        String directory  = config.get(configPropertyPrefix + ".policy.source.local.folder.path");
